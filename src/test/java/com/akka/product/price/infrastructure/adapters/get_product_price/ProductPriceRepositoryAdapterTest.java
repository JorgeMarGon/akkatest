...
import com.akka.product.price.infrastructure.persistence.jpa.ProductPriceJpa;
...
class ProductPriceRepositoryAdapterTest {
  ...
  void productPriceNotFound() {
    ...
    CustomException ex =
        assertThrows(CustomException.class, () -> mockAdapter.findAllByIdAndBrandId(productPrice));
